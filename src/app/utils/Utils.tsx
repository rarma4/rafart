export const FormacaoAcademica = [
  {
    ...
    "data": "2015 - 2018",
    "descricao": "Bacharel em Sistemas de Informação, Desenvolvedor Frontend | React.js | NextJs | PHP | Wordpress | Node.js | TypeScript | API Rest | Amazon S3 | MySql | PostgreSQL | Bootstrap | Styled Components | Tailwind | SCSS.",
  }
]
